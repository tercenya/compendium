            ...
            <div className="row">
              <div className="col-md-12" role="main">
                <div className="compendium-section">
                  ...
                  <h4>A development environment</h4>
                  <p>
                  ...
                  <h4>A League of Legends account</h4>
                  <p>
                  ...
                  <h4>Working knowledge of JSON</h4>
                  ...
                  <p>
                    ...
                    For a generic overview, consider <A href="http://www.w3schools.com/json/default.asp">w3schools</A>.
                  </p>

                  <p>
                    I would <b>not</b> recommend trying to read the <A href="http://www.json.org/">specifications</A>; it's a complicated mess.  I <b>would</b> recommend using a library in your language of choice to process the JSON into a usable Array or Hash.
                  </p>

                  <h4>Getting a development key</h4>

                  <p>
                    To acquire or look up your Developer API key, log into the Riot <A href="https://developer.riotgames.com/sign-in">developer website</A> with your League of Legends credentials.  In the middle of your dashboard is your Development key, along with a button to create a new one.
                  </p>
